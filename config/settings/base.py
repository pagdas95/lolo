...
MIGRATION_MODULES = {"sites": "lolo.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "lolo.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
# EMAIL_PORT = 587
# EMAIL_HOST_USER = "lololympicstest@gmail.com"
# EMAIL_HOST_PASSWORD = "gvhxegugpyssivpn"
# DEFAULT_FROM_EMAIL = "lololympicstest@gmail.com" # same with EMAIL_HOST_USER
# EMAIL_USE_TLS = True
# EMAIL_USE_SSL = False
...
ADMINS = [("""Pantelis Athanasiou""", "pantelisa1995@gmail.com")]
...
SOCIALACCOUNT_ADAPTER = "lolo.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "lolo.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "lolo API",
    "DESCRIPTION": "Documentation of API endpoints of lolo",
    "VERSION": "1.0.0",
